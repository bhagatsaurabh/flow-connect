...
describe('Vector2', () => {
  describe('Constructor', () => {
    it('should create a Vector2 with single DOMPoint', () => {
      let vector = new Vector2(new DOMPoint(20, 20));
    ...
    it('should create a Vector2 with two co-ords', () => {
      let vector = new Vector2(100, 150);
    ...
    it('should create a Vector2 with default values without args', () => {
      let vector = new Vector2();
      expect(vector).to.be.an.instanceOf(Vector2);
      expect(vector).to.have.property('x', 0);
      expect(vector).to.have.property('y', 0);

      vector = new Vector2(100);
      expect(vector).to.be.an.instanceOf(Vector2);
      expect(vector).to.have.property('x', 100);
      expect(vector).to.have.property('y', 0);

      vector = new Vector2(undefined, 200);
      expect(vector).to.be.an.instanceOf(Vector2);
      expect(vector).to.have.property('x', 0);
  ...
  describe('Subtraction', () => {
    it('should create a new vector when subtracting from another vector', () => {
      let vector1 = new Vector2(50, 50);
      let vector2 = new Vector2(25, 30);
    ...
    it('should create a new vector when subtracting respectively from co-ords using two scalars', () => {
      let vector1 = new Vector2(20, 100);
  ...
  describe('In-place Subtraction', () => {
    ...
    it('should subtract from a scalar in-place', () => {
      let vector1 = new Vector2(180, 155);
    ...
    it('should subtract two scalars respectively in-place from two co-ords', () => {
      let vector1 = new Vector2(100, 200);
  ...
  describe('Multiplication', () => {
    it('should create a new vector when multiplying with another vector', () => {
      let vector1 = new Vector2(63, 74);
      let vector2 = new Vector2(72, 14);
  ...
  describe('Maximum of two co-ords', () => {
    it('should return maximum of two co-ords', () => {
      let vector = new Vector2(127.383, 127.738);
  ...
  describe('Clone', () => {
    it('should create a clone', () => {
      let vector = new Vector2(100, 200);
  ...
  describe('Clamp', () => {
    it('should clamp co-ords within given bounds', () => {
      let vector = new Vector2(126.734, 192.427);
  ...
  describe('Static Functions', () => {
    it('should calculate distance given two vectors', () => {
      let vector1 = new Vector2(727, 168);
      let vector2 = new Vector2(342, 572);
      let distance = Vector2.Distance(vector1, vector2);
    ...
    it('should calculate distance given two pair of co-ords', () => {
      let distance = Vector2.Distance(727, 168, 342, 572);
    ...
    it('should calculate midpoint given two vectors', () => {
      let vector1 = new Vector2(727, 168);
      let vector2 = new Vector2(342, 572);
      let midpoint = Vector2.Midpoint(vector1, vector2);
    ...
    it('should create a random vector within bounds', () => {
      let randomVector = Vector2.Random(10, 20, 100, 150);
  ...
  describe('Serialization and De-serialization', () => {
    it('should serialize', () => {
      let vector = new Vector2(273.737, 926.821);
    ...
    it('should de-serialize', () => {
      let vector = new Vector2(93.727, 197.75);
      let deSerializedVector = Vector2.deSerialize(vector.serialize());
