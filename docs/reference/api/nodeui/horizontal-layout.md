...
For common usages, this constructor is not recommended, use <Ref to="../classes/node#createhozlayout">Node.createHozLayout</Ref> instead.
:::

<Method type="constructor">
  <template v-slot:signature>
    new HorizontalLayout(<strong>node: </strong><em><Ref to="../classes/node">Node</Ref></em>,
    <strong>childs: </strong><em><Ref to="../classes/ui-node">UINode</Ref>[]</em>,
    <strong>options: </strong><em><Ref to="../interfaces/horizontal-layout-options">HorizontalLayoutOptions</Ref></em>):
    <em><Ref to="#class-horizontallayout">HorizontalLayout</Ref></em>
  </template>
  <template v-slot:params>
    <Param name="node"><em><Ref to="../classes/node">Node</Ref></em></Param>
    <Param name="childs"><em><Ref to="../classes/ui-node">UINode</Ref>[]</em></Param>
    <Param name="options">
      <em><Ref to="../interfaces/horizontal-layout-options">HorizontalLayoutOptions</Ref></em>
...
<script setup>
import data from '../../../../../reflections/api/classes/horizontal-layout.json';
</script>
