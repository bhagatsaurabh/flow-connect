...
For common usages, this constructor is not recommended, use <Ref to="../classes/node#createimage">Node.createImage</Ref> instead.
:::

<Method type="constructor">
  <template v-slot:signature>
    new Image(<strong>node: </strong><em><Ref to="../classes/node">Node</Ref></em>,
    <strong>sourceString: </strong><em>string</em>,
    <strong>options: </strong><em><Ref to="../interfaces/image-options">ImageOptions</Ref></em>):
    <em><Ref to="#class-image">Image</Ref></em>
  </template>
  <template v-slot:params>
    <Param name="node"><em><Ref to="../classes/node">Node</Ref></em></Param>
    <Param name="sourceString"><em>string</em></Param>
    <Param name="options">
      <em><Ref to="../interfaces/image-options">ImageOptions</Ref></em>
...
<Property type="property" name="src">
...
<script setup>
import data from '../../../../../reflections/api/classes/image.json';
</script>
