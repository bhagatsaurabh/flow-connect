...
// let random1 = StandardNodes.Common.Random(flow);
// let random2 = StandardNodes.Common.Random(flow);
// let random3 = StandardNodes.Common.Random(flow);
// let random4 = StandardNodes.Common.Random(flow);
...
// let sync = StandardNodes.Common.SyncEvent(flow, {}, 4);
