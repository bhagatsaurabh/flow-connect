...
let node = flow.createNode('Test Node', new Vector(50, 50), 250, {
...
let numberNode = flow.createNode('Number Source', new Vector(50, 50), 140, {
  state: { value: 15 },
  style: { padding: 10, spacing: 10, rowHeight: 10 }
});
...
let textNode = flow.createNode('Text Source', new Vector(50, 120), 140, {
...
let toggleNode = flow.createNode('Toggle Source', new Vector(50, 190), 140, {
  state: { value: true },
  style: { padding: 10, spacing: 10, rowHeight: 10 }
});
...
flow2.addInput('Input 1', 'number', new Vector(100, 100));
flow2.addOutput('Output 1', 'string', new Vector(200, 200));
let convertNode = flow2.createNode('Converter', new Vector(50, 50), 130, {
...
let subFlowNode = flow.addSubFlow(flow2, new Vector(200, 200));
