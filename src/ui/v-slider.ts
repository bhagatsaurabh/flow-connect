...
export class VSlider extends UINode implements Serializable<SerializedVSlider> {
  ...
  constructor(
    ...
    super(node, Vector.Zero(), UIType.VSlider, {
      draggable: true,
      style: options.style
        ? { ...DefaultVSliderStyle(node, options.width), ...options.style }
        : DefaultVSliderStyle(node, options.width),
